...
try{
const msr = (await fetchJson('https://raw.githubusercontent.com/criss-vevo/CRISS-DATA/refs/heads/main/MSG/mreply.json')).replyMsg
...
async(conn, mek, m,{from, l, quoted, body, isCmd, command, mentionByTag , args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isCreator ,isDev, isAdmins, reply}) => {
try{
const msr = (await fetchJson('https://raw.githubusercontent.com/kcriss-vevo/CRISS-DATA/refs/heads/main/MSG/mreply.json')).replyMsg
