...
cmd({
    ...
    try {
        ...
        // Image AI à envoyer
        const ALIVE_IMG = 'https://files.catbox.moe/xro4ka.jpeg'; // Remplacez par l'URL de votre image AI

        // Légende avec des informations formatées
        const formattedInfo = `🤖 *Criss's Response:*\n\n${gptResponse}`;
...
cmd({
    ...
    try {
        ...
        // AI image to attach
        const AI_IMG = 'https://files.catbox.moe/xro4ka.jpeg'; // Replace with a valid image URL
